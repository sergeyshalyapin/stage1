...
- активное и неактивное состояние клавиш пианино отличаются по стилю. В активное состояние клавиша пианино переходит как при клике по ней мышкой, так и при клике по соответствующей ей клавише клавиатуры
...
- дополнительная функциональность (не оценивается). Можно провести мышкой с зажатой левой кнопкой по клавишам пианино, при этом они будут нажиматься и звучать. Такая функциональность есть в предложенных в материалах демо.
