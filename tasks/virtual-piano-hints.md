...
В выполнении задания поможет видео курса JS30 [JavaScript Drum Kit](https://youtu.be/VuN8qwZoego), ссылка на которое приводится в материалах к заданию. В нём автор выполняет очень похожее приложение. Предложенное автором решение можно немного усовершенствовать, использовав делегирование и сократив количество плееров на странице до одного. Также вместо 
свойства `event.keyCode`, лучше использовать `event.Code`, возвращающее более осмысленный и понятный результат. 
