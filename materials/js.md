...
В ходе stage1 вы изучите теорию базового JavaScript в ходе прослушивания лекций и работы с дополнительными материалами, усовершенствуете умение решать задачи, примените свои знания на практике для создания js-проектов.

## Задания
- [сodewars](tasks/codewars.md)
